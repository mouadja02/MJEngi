    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          {/* Brand & Description */}
          <div>
            <h3 className="text-2xl font-bold font-heading gradient-text mb-4">
              Mouad Jaouhari
            </h3>
            <p className="text-gray-300 mb-4">
              Data & ML Engineer passionate about building intelligent systems and solving complex data challenges.
            </p>
            <p className="text-gray-400 text-sm">
              Based in Pessac, France • Available for opportunities
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-gray-300">
                <span className="text-gray-400">Email:</span> mouad.jaouhari@bordeaux-inp.fr
              </p>
              <p className="text-gray-300">
                <span className="text-gray-400">Location:</span> Pessac, France
              </p>
              <div className="flex space-x-4 mt-4">
                <a
                  href="https://www.linkedin.com/in/j-mouad/"
                  target="_blank"
                ...
                <a
                  href="https://github.com/mouadja02"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-primary-400 transition-colors duration-200"
                >
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Mouad Jaouhari. All rights reserved.
          </p>
